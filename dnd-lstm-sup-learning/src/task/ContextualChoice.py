...
class ContextualChoice():
    ...
    def __init__(self, obs_dim, trial_length=10, t_noise_off=5):
        self.obs_dim = obs_dim #num_arms
        self.ctx_dim = obs_dim #barcode_size
        self.trial_length = trial_length #pulls_per_episode
        self.t_noise_off = t_noise_off 
        # 2nd level params
        self.x_dim = self.obs_dim + self.ctx_dim
        self.y_dim = 1      #lstm_output, but need to be manually set to 1
        # input validation
    ...
    def sample(
        ...
        Parameters
        ----------
        n_unique_examples : type #num_barcodes
